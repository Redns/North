...
namespace North.RCL.Cards
{
    public partial class UserCard
    {
        ...
        ///// 用户权限标签文本
        ///// </summary>
        //public string PermissionChipText =>
        ...
        ///// 用户权限标签颜色
        ///// </summary>
        //public Color PermissionChipColor =>
        //    User.Permission switch
        //    {
        ...
        //    $"{User.SingleMaxUploadNums}张 / {User.SingleMaxUploadSize:f2} MB (单次)，{User.MaxUploadNums}张 / {User.MaxUploadSize:f2} MB (全部)";
    }
}
